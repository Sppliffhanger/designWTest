...
void testProject_initialize(void)
{
  ...
  /* External mode info */
  testProject_M->Sizes.checksums[0] = (3847184229U);
  testProject_M->Sizes.checksums[1] = (346407772U);
  testProject_M->Sizes.checksums[2] = (1230463348U);
  testProject_M->Sizes.checksums[3] = (858026630U);
